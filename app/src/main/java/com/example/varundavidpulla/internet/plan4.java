...
public class plan4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlan4=mDatabase.child("Plans").child("plan4");
        mPlan4.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        but4=(Button) findViewById(R.id.r14);
        but4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(plan4.this,payment.class);
