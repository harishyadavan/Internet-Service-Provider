...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra(registration.PARENT_ID));
        ...
        textViewArtist.setText(intent.getStringExtra(registration.PARENT_NAME));
